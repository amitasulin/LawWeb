    ...
    <footer className="bg-primary text-white mt-20">
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-accent">אודות המשרד</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-accent">קישורים מהירים</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-accent">יצירת קשר</h3>
          ...
          {/* Social & Legal */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-accent">רשתות חברתיות</h3>
